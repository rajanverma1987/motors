 ...
 * Sets EXPO_PUBLIC_API_URL from eas.json → build.production.env before eas update.
 */
...
if (!url || typeof url !== "string") {
  console.error(
    "Missing eas.json → build.production.env.EXPO_PUBLIC_API_URL (production API base URL)."
  );
  process.exit(1);
}
