  ...
  return (
    <ScrollView style={S.scroll} contentContainerStyle={[S.content, { paddingBottom: insets.bottom + 24 }]}>
      ...
      <SaveCalculationButton
        ...
        title="Bench electrical"
        getPayload={() => ({
          title: "error" in solved && solved.error ? "Bench electrical" : `V ${fmt(solved.V, 2)} / I ${fmt(solved.I, 3)} A`,
          inputs: { v, i, r, p, mode, ra, rb, rc },
          results: { ohm: solved, delta: deltaOut },
        })}
      />
    </ScrollView>
  );
