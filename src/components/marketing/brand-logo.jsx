...
export default function BrandLogo({
  ...
  return (
    <span
      className={`brand-logo-frame inline-flex max-w-full items-center rounded-md px-1.5 py-1 dark:bg-[linear-gradient(180deg,hsl(32_28%_96%)_0%,hsl(28_22%_90%)_100%)] dark:shadow-[0_0_0_1px_hsl(28_18%_78%),0_0_18px_-2px_hsl(var(--primary)/0.55),inset_0_1px_0_0_hsl(38_40%_98%)] ${wrapperClassName}`.trim()}
    >
      <Image
