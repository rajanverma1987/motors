...
const STEPS = [
  ...
  },
  {
    ...
    body:
      "Before the motor leaves your facility, get a written commitment on: estimated return date, emergency rate (expect 25–50% above standard), what testing will be performed, and warranty coverage on the emergency repair.",
  },
];
      ...
      <div className={`${LISTINGS_PAGE_CONTAINER} py-8 sm:py-10`}>
        ...
        <section aria-labelledby="cost-heading" className="mt-12 max-w-3xl">
          ...
          <p className="mt-4 text-sm leading-relaxed text-secondary">
            Emergency motor repair carries a 25–50% premium above standard rates due to overtime labor, expedited parts
            sourcing, and priority queue placement. For production lines where downtime costs $1,000–$10,000 per hour,
            this premium is almost always justified.
          </p>
          <p className="mt-3 text-sm leading-relaxed text-secondary">
            Benchmark ranges at emergency rates: bearing replacement $300–$1,800 depending on frame size; full rewind on
            a 10–50 HP motor $1,800–$5,000; large frame rewinds (above 200 HP) are quoted individually. Always confirm
