    ...
    <article className="mx-auto max-w-[67.2rem] px-4 py-12 sm:px-6 sm:py-16">
        ...
        <dl className="mt-8 space-y-8">
          <div>
            ...
            <dd className="mt-2 text-secondary leading-relaxed">
              ...
              must test-determine specs before quoting — add 1–2 days, and expect a higher inspection fee because they
          ...
          <div>
            ...
            <dd className="mt-2 text-secondary leading-relaxed">
              ...
              motor on a pump that actually needs 30 HP will fail again in 12–18 months if you rewind it without
          ...
          <div>
            ...
            <dd className="mt-2 text-secondary leading-relaxed">
              ...
              typically run 25–50% above standard rates but can compress a 7-day repair into 24–48 hours.
            </dd>
          </div>
          <div>
        ...
        <ul className="mt-8 grid list-none gap-4 p-0 sm:grid-cols-2">
          <li className="rounded-2xl border border-border bg-card p-5">
            ...
            <p className="mt-3 text-sm leading-relaxed text-secondary">
              This is the most widely repaired type — most established shops within a typical 50–100 mile service
              radius handle it. For three-phase motors above 100 HP, confirm rewind capability at your voltage and that
              they have done your frame size before; a shop that mainly rewinds 5–25 HP HVAC motors will not have VPI
          ...
          <li className="rounded-2xl border border-border bg-card p-5">
            ...
            <p className="mt-3 text-sm leading-relaxed text-secondary">
              ...
              rewinds often run $15,000–$100,000+ on large frames and cannot be undone if the coils are built wrong.
      ...
      <section className="mt-16">
        ...
        <ol className="mt-8 list-none space-y-8 p-0">
          ...
          <li>
            ...
            <p className="mt-2 text-secondary leading-relaxed">
              Standard coverage is 12 months on parts and labor; some shops offer 18–24 months. Ask what it covers
      ...
      <section className="mt-16">
        ...
        <p className="mt-4 text-secondary leading-relaxed">
          ...
          88–91%. Current NEMA Premium motors typically run at 93–96%. For a 50 HP motor at 6,000 hours per year and
          $0.12/kWh, that 4–5% gap is roughly $1,200–$1,500 per year. If the motor misses NEMA Premium and runs more
          than 4,000 hours per year, energy savings can pay for replacement in 2–3 years — factor that in before you
        ...
        <p className="mt-4 text-secondary leading-relaxed">
          ...
          replacement can take 12–20 weeks. Then repair is often the only practical option regardless of the 50% rule.
      ...
      <section className="mt-16">
        ...
        <dl className="mt-6 grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-border bg-card p-4">
            ...
            <dd className="mt-1 text-secondary">$150–$600</dd>
          </div>
          <div className="rounded-xl border border-border bg-card p-4">
            <dt className="font-semibold text-title">Bearing replacement, 25–100 HP</dt>
            <dd className="mt-1 text-secondary">$400–$1,200</dd>
          </div>
          <div className="rounded-xl border border-border bg-card p-4">
            <dt className="font-semibold text-title">Full rewind, 1–10 HP</dt>
            <dd className="mt-1 text-secondary">$400–$900</dd>
          </div>
          <div className="rounded-xl border border-border bg-card p-4">
            <dt className="font-semibold text-title">Full rewind, 10–50 HP</dt>
            <dd className="mt-1 text-secondary">$1,200–$3,500</dd>
          </div>
          <div className="rounded-xl border border-border bg-card p-4">
            <dt className="font-semibold text-title">Full rewind, 50–200 HP</dt>
            <dd className="mt-1 text-secondary">$3,000–$9,000</dd>
          </div>
          <div className="rounded-xl border border-border bg-card p-4">
            <dt className="font-semibold text-title">Emergency surcharge</dt>
            <dd className="mt-1 text-secondary">25–50% above the standard rate</dd>
          </div>
          <div className="rounded-xl border border-border bg-card p-4 sm:col-span-2">
            ...
            <dd className="mt-1 text-secondary">$150–$600 depending on motor size and distance</dd>
          </div>
        </dl>
        <p className="mt-4 text-secondary leading-relaxed">
