...
const faqs = [
  ...
  },
  {
    ...
    a: "Standard motor rewinding takes 5–10 business days. Emergency rewinding can be done in 24–72 hours. Sourcing a surplus motor in the correct frame, voltage, and HP can take 1–4 weeks depending on the size and how obscure the specification is. For large-frame motors above 200 HP, rewinding is almost always faster than finding a compatible surplus unit.",
  },
  {
        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none">
                ...
                <dl className="mt-4 space-y-3 text-sm">
                  <div>
                    ...
                    <dd className="mt-0.5 text-secondary">
                      $400–$9,000 depending on HP and motor type. Large-frame motors above 200 HP quoted individually.
                    </dd>
                  </div>
                  <div>
                    <dt className="text-xs font-bold uppercase tracking-wide text-secondary">Lead time</dt>
                    <dd className="mt-0.5 text-secondary">
                      5–10 business days standard. 24–72 hours emergency. Predictable — doesn&apos;t depend on parts
                      availability.
                    </dd>
                  </div>
                  <div>
              ...
              <div className="rounded-xl border border-primary/30 bg-primary/[0.06] p-5">
                ...
                <dl className="mt-4 space-y-3 text-sm">
                  <div>
                    <dt className="text-xs font-bold uppercase tracking-wide text-secondary">Upfront cost</dt>
                    <dd className="mt-0.5 text-secondary">
                      Varies wildly. Small standard motors can be $200–$800. Large or specialty motors are scarce —
                      $5,000–$30,000+ for 200+ HP units.
                    </dd>
                  </div>
                  <div>
                    <dt className="text-xs font-bold uppercase tracking-wide text-secondary">Lead time</dt>
                    <dd className="mt-0.5 text-secondary">
                      1–4 weeks depending on frame size and specification. Large or specialty motors can take months.
                    </dd>
                  </div>
                  <div>
                    <dt className="text-xs font-bold uppercase tracking-wide text-secondary">Warranty</dt>
                    <dd className="mt-0.5 text-secondary">
                      Usually 30–90 days on electrical function — not on internal condition or run hours.
                    </dd>
                  </div>
                  <div>
                    <dt className="text-xs font-bold uppercase tracking-wide text-secondary">Condition</dt>
          ...
          <section aria-labelledby="cost-heading">
              ...
              <table className="w-full min-w-[36rem] border-collapse text-left text-sm">
                ...
                <tbody className="text-secondary">
                  <tr className="border-b border-border">
                    <td className="px-4 py-3 font-medium text-title">1–10 HP</td>
                    <td className="px-4 py-3">$400–$900</td>
                  ...
                  <tr className="border-b border-border bg-muted/30">
                    <td className="px-4 py-3 font-medium text-title">10–50 HP</td>
                    <td className="px-4 py-3">$1,200–$3,500</td>
                    <td className="px-4 py-3">$500–$2,000</td>
                    <td className="px-4 py-3">Comparable — rewind wins on compatibility and warranty</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="px-4 py-3 font-medium text-title">50–100 HP</td>
                  ...
                  <tr className="border-b border-border bg-muted/30">
                    <td className="px-4 py-3 font-medium text-title">100–200 HP</td>
                    <td className="px-4 py-3">$4,000–$8,000</td>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3">$7,000–$25,000+</td>
                    <td className="px-4 py-3">Scarce — $15,000–$50,000+</td>
            ...
            <p className="mt-2 text-xs text-secondary">
              Sources: EASA member shop rate data, surplus motor dealer market prices (2024–2025). Get a real quote for
              ...
              {[
                {
                  ...
                  d: "A surplus motor that fails within 90 days leaves you with a warranty dispute and downtime twice. Factor a realistic 15–25% probability of early failure on undocumented surplus — that cost often exceeds the price difference.",
                },
                {
                ...
                },
                {
                  ...
                  d: "A surplus motor predating EISA 2007 may run at 88–91% efficiency vs 93–96% for a rewound motor held to EASA AR100. For a 50 HP motor at 6,000 hours/year and $0.12/kWh, a 4% gap is roughly $1,200/year — $6,000 over five years.",
                },
              ].map((item) => (
          ...
          <section aria-labelledby="surplus-right-heading">
            ...
            <ul className="mt-4 list-disc space-y-3 pl-6 text-secondary">
              ...
              <li>
                ...
                run 4,000+ hours/year may pay back with a new Premium motor in 2–3 years — new, not surplus.
              </li>
              <li>
