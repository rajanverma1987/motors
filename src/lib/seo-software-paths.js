/**
 * Software SEO page cluster paths (documents/Seo.md).
 * Use these constants so internal links stay consistent.
 */

export const SEO_SOFTWARE_PILLAR_PATH = "/motor-repair-shop-management-software";
export const SEO_SOFTWARE_WORK_ORDER_PATH = "/work-order-software-for-motor-repair-shops";
export const SEO_SOFTWARE_INVENTORY_PATH = "/motor-repair-inventory-software";
